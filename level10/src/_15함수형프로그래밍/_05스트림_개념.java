...
public class _05스트림_개념 {
	...
	public static void main(String[] args) {
		...
		List<String> names = Arrays.asList("박시현","유재석","하하","정형돈","노홍철","하하","박시현");
		...
		nameStream.forEach(System.out::println); // forEach는 최종연산 이기떄문에 연산이 끝나면 스트림 닫힌다
//		nameStream.count(); 이미 닫혔다는 에러 발생
		...
		List<Integer> list = new ArrayList<>(Arrays.asList(5,2,0,8,4,1,7,4,6,2));
